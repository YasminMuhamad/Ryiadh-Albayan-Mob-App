      ...
      <View style={styles.aboutContainer}>
        ...
        <View style={styles.aboutTextContainer}>
          ...
          <Text style={styles.aboutText}>
            Riyad Al-Bayan Center is a trusted online platform dedicated to teaching Arabic
            language and Islamic sciences to students around the globe.
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  heroContainer: { paddingTop: 60, paddingHorizontal: 16, alignItems: "center" },
  heroBadge: { backgroundColor: "#e6f1ee", paddingVertical: 4, paddingHorizontal: 12, borderRadius: 50, marginBottom: 8 },
  heroBadgeText: { color: "#21746c", fontSize: 14 },
  heroTitle: { fontSize: 32, color: "#21746c", fontFamily: Fonts.poppins, fontWeight: FontWeights.normal, textAlign: "center", marginBottom: 8 },
  heroSubtitle: { fontSize: 18, color: "#6E6E73", textAlign: "center", marginBottom: 24 },

  aboutContainer: { flexDirection: "row", padding: 16, alignItems: "center", justifyContent: "center", backgroundColor: "#fff", marginBottom: 24 },
  ...
  sectionContainer: { padding: 16, marginBottom: 24 },
  sectionTitle: { fontSize: 22, fontFamily: Fonts.poppins, fontWeight: FontWeights.medium, color: "#1D1D1F", marginBottom: 12 },
  loadingText: { textAlign: "center", color: "#6E6E73" },
  cardsContainer: { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 12 },

  courseCard: { backgroundColor: "#fff", borderRadius: 16, padding: 12, width: 200, marginBottom: 16, borderWidth: 1, borderColor: "#eee" },
  courseImage: { width: "100%", height: 100, borderRadius: 12, marginBottom: 6 },
  ...
  courseButton: { backgroundColor: "#21746c", borderRadius: 50, paddingVertical: 6, paddingHorizontal: 12 },
  courseButtonText: { color: "#fff", textAlign: "center" },

  teacherCard: { backgroundColor: "#fff", borderRadius: 16, padding: 12, width: 200, marginBottom: 16, borderWidth: 1, borderColor: "#eee", alignItems: "center" },
  teacherImage: { width: "100%", height: 100, borderRadius: 12, marginBottom: 6 },
  ...
  reviewCard: { backgroundColor: "#fff", borderRadius: 16, padding: 12, width: 200, marginBottom: 16, borderWidth: 1, borderColor: "#eee" },
  ...
  ctaContainer: { backgroundColor: "#0E9F9F", padding: 24, alignItems: "center", marginBottom: 24, borderRadius: 16 },
  ctaTitle: { color: "#fff", fontSize: 18, fontWeight: "600", marginBottom: 8, textAlign: "center" },
