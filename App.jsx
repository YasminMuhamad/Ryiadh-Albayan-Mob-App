  ...
  return (
    <DrawerContentScrollView {...props} contentContainerStyle={{ backgroundColor: Colors.sidebar }}>
      <View style={styles.drawerHeader}>
        ...
        <Text style={styles.logoText}>Riyadh Albayan</Text>
      </View>
  ...
  return (
    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          title: "Cart",
          drawerIcon: ({ color, size }) => <Feather name="shopping-cart" size={size} color={color} />,
          drawerLabel: ({ color }) => (
      ...
      <Drawer.Screen
        ...
        options={{ title: "Course Details", drawerItemStyle: { display: "none" } }}
      />
